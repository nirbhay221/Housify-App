...
class propertyNearbyListAdapter (private val propertyList: ArrayList<propertyModel>): RecyclerView.Adapter<propertyNearbyListAdapter.MyPropertyNearbyViewHolder>() {
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): propertyNearbyListAdapter.MyPropertyNearbyViewHolder {

        val itemView = LayoutInflater.from(parent.context)
            .inflate(R.layout.property_posted_item_view, parent, false)

        return MyPropertyNearbyViewHolder(itemView)
    }


    override fun onBindViewHolder(holder: propertyNearbyListAdapter.MyPropertyNearbyViewHolder, position: Int) {
    ...
    public class MyPropertyNearbyViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
